...
# KORRIGIERT: attendee_count ist jetzt gegen fehlende Tabellen abgesichert.
...
from django.db import ProgrammingError # Importieren
from .models import (
...
class MemorialEventInline(admin.TabularInline):
    ...
    def attendee_count(self, obj):
        # VERBESSERUNG: Fängt den Fehler ab, falls die Tabelle noch nicht existiert.
        try:
            return obj.attendees.count()
        except ProgrammingError:
            return "N/A (Migration ausstehend)"
