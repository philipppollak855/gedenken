    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to='media_assets/%Y/%m/', verbose_name='Datei')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='Beschreibung')),
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='api.memorialpage')),
            ],
            options={
                'verbose_name': 'Termin',
