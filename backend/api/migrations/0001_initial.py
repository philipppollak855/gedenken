    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('vorsorgender', 'Vorsorgender'), ('angehoeriger', 'AngehÃ¶riger'), ('gast', 'Gast'), ('administrator', 'Administrator')], default='vorsorgender', max_length=20, verbose_name='Rolle')),
                ('consent_admin_access', models.BooleanField(default=False, verbose_name='Zustimmung Admin-Zugriff')),
                ('profile_completeness', models.IntegerField(default=0, verbose_name='Profil-VollstÃ¤ndigkeit')),
                ('is_active', models.BooleanField(default=True, verbose_name='Aktiv')),
                ('is_staff', models.BooleanField(default=False, verbose_name='Mitarbeiter')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Erstellt am')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Zuletzt geÃ¤ndert')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100, unique=True, verbose_name='Titel (fÃ¼r Dropdown)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=255, verbose_name='Adresse (StraÃŸe, PLZ, Ort)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music_wishes', models.JSONField(blank=True, default=list, verbose_name='MusikwÃ¼nsche')),
                ('speaker_wishes', models.TextField(blank=True, verbose_name='RednerwÃ¼nsche')),
                ('flower_wishes', models.TextField(blank=True, verbose_name='BlumenwÃ¼nsche')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Zuletzt geÃ¤ndert')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_background_size', models.CharField(choices=[('cover', 'Gestreckt (fÃ¼llend)'), ('contain', 'Eingepasst (komplett sichtbar)')], default='cover', max_length=10, verbose_name='Anpassung Hintergrundbild Hero')),
                ...
                ('farewell_background_size', models.CharField(choices=[('cover', 'Gestreckt (fÃ¼llend)'), ('contain', 'Eingepasst (komplett sichtbar)')], default='cover', max_length=10, verbose_name='Anpassung Hintergrundbild Abschied')),
                ('farewell_text_inverted', models.BooleanField(default=False, verbose_name='Textfarbe im Abschiedsbereich umkehren (fÃ¼r helle HintergrÃ¼nde)')),
                ...
                ('memorial_picture_back', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='api.mediaasset', verbose_name='Gedenkbild RÃ¼ckseite')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notice_period', models.CharField(blank=True, max_length=255, verbose_name='KÃ¼ndigungsfrist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_public', models.BooleanField(default=True, help_text='Wenn deaktiviert, ist der gesamte Termin nicht sichtbar.', verbose_name='Termin Ã¶ffentlich anzeigen')),
                ...
                ('donation_for', models.CharField(blank=True, help_text="z.B. 'Krebshilfe Ã–sterreich', 'Tierheim St. PÃ¶lten'", max_length=255, verbose_name='Spende zugunsten von')),
                ('description', models.TextField(blank=True, help_text='Platz fÃ¼r zusÃ¤tzliche Informationen, z.B. zum anschlieÃŸenden Leichenschmaus.', verbose_name='Weitere Details')),
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='api.memorialpage', verbose_name='ZugehÃ¶rige Gedenkseite')),
            ],
            options={
                'verbose_name': 'Termin',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('listing_title', models.CharField(blank=True, default='Wir trauern um', max_length=100, verbose_name='Titel Ã¼ber den Gedenkkarten')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_private', models.BooleanField(default=False, verbose_name='Nur fÃ¼r Familie')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Erstellt am')),
                ...
                ('candle_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.candleimage', verbose_name='AusgewÃ¤hltes Kerzenbild')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relative_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='family_links_as_relative', to=settings.AUTH_USER_MODEL, verbose_name='AngehÃ¶riger')),
            ],
            options={
