...
const PortalChoicePage = () => {
    ...
    const gedenkenColumnStyle = {
        ...
        '--slide-transparency': settings.gedenken_card_slide_transparency || '0.9',
    ...
    const vorsorgeColumnStyle = {
        ...
        '--slide-transparency': settings.vorsorge_card_slide_transparency || '0.9',
    ...
    const unterlagenColumnStyle = {
        ...
        '--card-bg-color': settings.unterlagen_card_background_color || '#5a6c7d',
        ...
        '--slide-transparency': settings.unterlagen_card_slide_transparency || '0.9',
