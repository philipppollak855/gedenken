...
class Command(BaseCommand):
    help = 'Lädt alle Kategorien für die Bestattungsvorsorge'

    def handle(self, *args, **options):
        self.stdout.write('Lade Bestattungsvorsorge-Kategorien...')
        ...
        for i, (name, desc, icon) in enumerate(bestattungsarten, 1):
            ...
            self.stdout.write(f'✓ Bestattungsart: {name}')
        ...
        for i, (name, desc, is_rel, religion, icon) in enumerate(verabschiedungsarten, 1):
            ...
            self.stdout.write(f'✓ Verabschiedungsart: {name}')
        ...
        for i, (name, desc, icon) in enumerate(musik_kategorien, 1):
            ...
            self.stdout.write(f'✓ Musik-Kategorie: {name}')
        ...
        for i, (name, desc, icon) in enumerate(vereins_kategorien, 1):
            ...
            self.stdout.write(f'✓ Vereins-Kategorie: {name}')
        ...
        for i, (name, desc, icon) in enumerate(grabarten, 1):
            ...
            self.stdout.write(f'✓ Grabart: {name}')
        ...
        for i, (name, desc, required, icon) in enumerate(dokument_kategorien, 1):
            ...
            self.stdout.write(f'✓ Dokument-Kategorie: {name}')
        ...
        for i, (name, desc, icon) in enumerate(digitaler_nachlass_kategorien, 1):
            ...
            self.stdout.write(f'✓ Digitaler Nachlass-Kategorie: {name}')
        
        self.stdout.write(
            self.style.SUCCESS('✓ Alle Bestattungsvorsorge-Kategorien wurden erfolgreich geladen!')
        )
