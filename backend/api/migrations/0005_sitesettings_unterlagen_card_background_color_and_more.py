...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0004_add_trauerdruck_models'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, default='0.9', help_text='Wert zwischen 0.0 (transparent) und 1.0 (undurchsichtig)', max_length=10, verbose_name='Slide-in Transparenz'),
        ),
        migrations.AlterField(
            model_name='sitesettings',
